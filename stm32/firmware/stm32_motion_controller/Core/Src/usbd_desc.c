...
/**
  ...
  *          Uses the standard ST CDC VID/PID (0x0483/0x5740) so the in-box
  *          Linux cdc_acm driver binds it as /dev/ttyACM*.
  ******************************************************************************
  */
...
#define USBD_MANUFACTURER_STRING      "Soc_China Robotics"
#define USBD_PRODUCT_STRING_FS        "STM32F411 Chassis VCP"

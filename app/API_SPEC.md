...
## Changelog
- **v1.2 (2026-06-21)**:命令类型表新增 `voice_control`(`params.enabled` 布尔,App 远程开/关机器人端侧语音监听)。复用现有命令通道,不新增端点;机器人侧执行见 `docs/superpowers/specs/2026-06-21-voice-asr-interaction-design.md` §4.5。

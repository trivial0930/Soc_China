...
class GimbalControllerNode(Node):
    ...
    def _declare_parameters(self) -> None:
        defaults = {
            ...
            "proportional_gain": 0.008,
            "integral_gain": 0.01,
            "integral_limit": 0.10,
            "target_slew_rate_deg_s": 16.0,
    ...
    def _build_controller(self) -> GimbalController:
        ...
        return GimbalController(
            ...
            config=ControlConfig(
                ...
                integral_gain=float(self.get_parameter("integral_gain").value),
